...
def validate_best_model(optimizer, device):
    ...
    best_model_path = os.path.join('yolo_training', f'yolov10_{optimizer}', 'weights', 'best.pt')
    ...
    csv_path = os.path.join('yolo_training', f'yolov10_{optimizer}', 'overall_metrics.csv')
...
def main():
    print("YOLOv10 model loading...")
    validation_results = [] 

    try:
        base_model_path = "D:/CSE-475Project/model/yolov10s.pt"
    ...
    if validation_results:
        ...
        csv_path = 'yolo_validation/best_model_validation_results_yolov10.csv'
        df.to_csv(csv_path, index=False)
...
if __name__ == '__main__':
    main()
    print("YOLOv10 training and validation completed.")